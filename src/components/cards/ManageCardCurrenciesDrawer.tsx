...
import type { CardCurrencyRow } from "@/hooks/useCardCurrencies";
...
interface ManageCardCurrenciesDrawerProps {
  open: boolean;
  onClose: () => void;
  currencies: CardCurrencyRow[];
...
export function ManageCardCurrenciesDrawer(props: ManageCardCurrenciesDrawerProps) {
  return (
    <AnimatePresence>
      {props.open && <ManageCardCurrenciesDrawerContent {...props} />}
    </AnimatePresence>
  );
}

function ManageCardCurrenciesDrawerContent({
  onClose,
  currencies,
  activeCurrency,
  isAdding,
  ...
  onAdd,
  onRemove,
}: ManageCardCurrenciesDrawerProps) {
        ...
        <div className="border-border/60 flex shrink-0 items-center justify-between border-b px-5 py-4">
          <div>
            ...
            <p className="text-muted-foreground text-xs">
              Add or remove currencies for your card tabs — independent from Budget
            </p>
          </div>
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-5 py-4">
          ...
          <div className="border-border/60 space-y-2 border-t pt-4">
            ...
            <p className="text-muted-foreground text-[10px] leading-relaxed">
              Removing a currency is only allowed when it has no cards. PHP and AED are seeded by
              default; your Budget currency list is managed separately.
            </p>
          </div>
        </div>
