...
export function BottomNav() {
  ...
  return (
    <nav className="border-border/60 bg-background/90 pb-safe fixed right-0 bottom-0 left-0 flex h-16 shrink-0 items-stretch border-t backdrop-blur-md md:hidden">
